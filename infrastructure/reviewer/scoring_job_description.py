...
Below is a job description and a CV. You must return a fair, realistic JSON score.
...
Your JSON must have the key "ats_rating" with numeric fields:
- overall_percentage
- skills_match
...
Use the deterministic score below as baseline guidance (you may adjust ±15% only if justified):
