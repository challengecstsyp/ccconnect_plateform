      ...
      >
        ...
        <nav className="p-4 space-y-2 pt-6">
          <div className="mb-6 space-y-1 border-b border-gray-100 pb-4">
             <Link href="/company/profile" onClick={() => setIsMenuOpen(false)} className={`flex items-center px-4 py-3 rounded-xl transition-colors duration-200 text-gray-700 hover:bg-gray-50 font-semibold ${pathname === '/company/profile' ? `bg-${UTOPHIA_COLOR}-100 text-${UTOPHIA_COLOR}-700` : ''}`}><User className="w-5 h-5 mr-3" /> Profil Entreprise</Link>
             <Link href="/company/settings" onClick={() => setIsMenuOpen(false)} className={`flex items-center px-4 py-3 rounded-xl transition-colors duration-200 text-gray-700 hover:bg-gray-50 ${pathname === '/company/settings' ? `bg-${UTOPHIA_COLOR}-100 text-${UTOPHIA_COLOR}-700` : ''}`}><Settings className="w-5 h-5 mr-3" /> Paramètres RH</Link>
          </div>
