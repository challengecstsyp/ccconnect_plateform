    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="relative py-24 lg:py-32 bg-gradient-to-br from-indigo-900 via-indigo-800 to-indigo-700 text-white">
            <div className="max-w-6xl mx-auto px-6 text-center">
                ...
                <Button
                    onClick={() => window.setCurrentPage('/register')}
                    // Fond Mauve clair (bg-indigo-100) et Texte Blanc (text-white)
                    // Aucune classe hover: n'est présente.
                    className="px-10 py-4 text-lg font-semibold rounded-full shadow-xl bg-indigo-100 text-white transition-all duration-300">
                    {/* L'icône doit aussi être blanche */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {heroFeatures.map(feature => (
                        <FeatureCard
                            ...
                            icon={feature.icon}
                            path="/dashboard" // Rediriger vers le dashboard après inscription/connexion
                        />
                    ))}
                </div>
            </div>
