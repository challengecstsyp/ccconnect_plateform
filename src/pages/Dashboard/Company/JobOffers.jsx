                        ...
                        offers.map((offer) => (
                            <div key={offer.id} className="p-4 flex justify-between items-center hover:bg-gray-50 transition-colors">
                                ...
                                <div className="flex space-x-2">
                                    <Button onClick={() => navigate(`/company/candidates?jobId=${offer.id}`)} primary={false} className="py-2 px-3 text-sm flex items-center border border-gray-300 hover:bg-gray-100">
