  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.is_complete) {
        // For the last question, show a button to view summary instead of auto-loading
        // The summary will be loaded when user clicks the button
      }
    } catch (error) {
      setError(error.message);
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-3">
                ...
                <Button
                  ...
                  disabled={isSubmitting || isLoading || !currentAnswer.trim()}
                >
                  {isSubmitting ? (
