...
const initialMockCandidates = [
    { id: 1, name: 'Omar', role: 'Ingénieur Logiciel', score: 93, location: 'Casablanca', exp: 5, status: 'Nouveau', lastContact: 'Jamais' },
    { id: 2, name: 'Salah', role: 'Analyste Financier', score: 88, location: 'Dubaï', exp: 8, status: 'En Entretien', lastContact: '2 jours' },
    { id: 3, name: 'Mohamed', role: 'UX Designer Senior', score: 95, location: 'Paris', exp: 10, status: 'Nouveau', lastContact: 'Jamais' },
    { id: 4, name: 'ALi', role: 'Data Scientist', score: 79, location: 'Riyad', exp: 3, status: 'Rejeté', lastContact: '1 semaine' },
];
